...
namespace xing\payment\sdk\aliPay\wappay\service;
...
class AlipayTradeService {
	 ...
	 * @param \xing\payment\sdk\aliPay\wappay\buildermodel\AlipayTradeWapPayContentBuilder $builder 业务参数，使用buildmodel中的对象生成。
	...
	function wapPay($builder,$return_url,$notify_url) {
		...
		$request = new \xing\payment\sdk\aliPay\aop\request\AlipayTradeWapPayRequest();
