...
class SDKConfig {
	...
	function __construct(){
        ...
        $path = defined('UNION_PATH') ? UNION_PATH : dirname(__FILE__);
		$configFilePath = $path . "/acp_sdk.ini";
		...
		// 补上地址
        !empty($this->validateCertDir) && $this->validateCertDir = $path . $this->validateCertDir;
        !empty($this->encryptCertPath) && $this->encryptCertPath = $path . $this->encryptCertPath;
        !empty($this->rootCertPath) && $this->rootCertPath = $path . $this->rootCertPath;
        !empty($this->middleCertPath) && $this->middleCertPath = $path . $this->middleCertPath;
        !empty($this->signCertPath) && $this->signCertPath = $path . $this->signCertPath;
	}
